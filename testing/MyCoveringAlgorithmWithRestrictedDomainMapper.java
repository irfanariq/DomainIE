 ...
 */
public class MyCoveringAlgorithmWithRestrictedDomainMapper extends Plugin {

    public MyCoveringAlgorithmWithRestrictedDomainMapper(PluginWrapper wrapper) {
        super(wrapper);
    }

    @Extension
    public static class MyCoveringAlgorithmWithRestrictedDomainMapperHandler extends IDomainMapperExtensionHandler {

        HashMap<String, String> availableConfigurations = new HashMap<>();

        @Override
        public String getPluginName() {
            return "My Covering Algorithm With Restricted Domain Mapper";
        }

        @Override
        public HashMap<String, String> getAvailableConfigurations() {
            availableConfigurations.putIfAbsent("Rule Name", "My Covering Algorithm Rule With Restricted");
        ...
        public HashSet<Rule> generateRule(HashMap<File, DomainDatas> fileDomainDatasHashMap) throws Exception {
            ...
            while (!kandidat.isEmpty()) {
                ...
                for (Rule aturan : kandidat) {
                    kandidatTemp.addAll(generalize(aturan, "indicator"));
                }
        ...
        private HashSet<Rule> generalize(Rule genrule, String restricted) {
            /**
            ...
            for (Map.Entry entry : genrule.getArg1Constraint().entrySet()) {
                ...
                if (!kelas.toLowerCase().contains(restricted.toLowerCase())) {
