 ...
 */
public class DetikBolaCrawler extends Plugin {

    public DetikBolaCrawler(PluginWrapper wrapper) {
        super(wrapper);
    }

    @Extension
    public static class DetikBolaCrawlerHandler extends ICrawlerExtensionHandler {

        HashMap<String, String> availableConfigurations = new HashMap<>();

        public String getPluginName() {
            return "Detik.com Bola";
        }
        ...
        public HashSet<String> getCrawlerStartingUrls() {
            ...
            urls.add("https://sport.detik.com/sepakbola/");
...
//                    link.contains("detik.com/berita-ekonomi-bisnis/");
            return link.contains("sport.detik.com/sepakbola/liga-inggris/");
        }
