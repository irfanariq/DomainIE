...
public class DataprocessorFileReader extends Plugin {

    public DataprocessorFileReader(PluginWrapper wrapper) {
        super(wrapper);
    }

    @Extension
    public static class DataprocessorFileReaderHandler extends IDataprocessorFileHandler {

        HashMap<String, String> availableConfigurations = new HashMap<>();

        public String getPluginName() {
            return "Dataprocessor File Reader";
        }
            ...
            if (getAvailableConfigurations().get("Input Directory") == null) {
                throw new Exception("Read directory path must be specified");
                 ...
                 for (File _file: files) {
                     pipelineItems.put(_file, Pair.of(null, null));
                 }
