 ...
 */
public class ClassRecognizerDomainDataFileWriter extends Plugin {

    public ClassRecognizerDomainDataFileWriter(PluginWrapper wrapper) {
        super(wrapper);
    }

    @Extension
    public static class ClassRecognizerDomainDataFileWriterHandler extends IClassRecognizerFileHandler {

        HashMap<String, String> availableConfigurations = new HashMap<>();

        public String getPluginName() {
            return "Class Recognizer Domain Data File Writer";
        }
        ...
        public void writeDomainData(File file, DomainDatas domainData) throws Exception {
            if (getAvailableConfigurations().get("Output Domain Data Directory") == null) {
                throw new Exception("Write directory path must be specified");
            } else {
                if (domainData != null) {
                    Utilities.writeToFile(availableConfigurations.get("Output Domain Data Directory"), file.getName(), domainData.toStringWithClass());
                }else {
