...
public class PostprocessorFileWriter extends Plugin {
    ...
    public static class PostprocessorFileWriterHandler extends IPostprocessorFileHandler {
        ...
        public HashMap<String, String> getAvailableConfigurations() {
            availableConfigurations.putIfAbsent("Output Directory", System.getProperty("user.dir") + File.separator + new Config().getProperty("POSTPROCESSES_OUTPUT_RELATIVE_PATH").replaceAll("\\.", Matcher.quoteReplacement(System.getProperty("file.separator"))));
